...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Homepage: header always visible, background transitions on scroll
      // Other pages: hide/show header based on scroll direction
      if (!isHomepage) {
        ...
        // Homepage: always keep header visible
        setIsVisible(true);
      }
